...
def retriever_tool(question):
    """
    A tool to retrieve relevant documents from a vector store based on the question.
    """
    ...
    vector_store = PineconeVectorStore(index=pc.Index(config["vecto_db"]["index_name"]),
